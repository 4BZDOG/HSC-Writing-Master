...
import { safeSetItem, safeGetItem, loadUserProfile, saveUserProfile, STORAGE_KEYS } from '../utils/storageUtils';
...
export const authService = {
  ...
  refreshSession: async (user: User): Promise<User> => {
      ...
      if (updatedStats.streakDays !== user.stats.streakDays || updatedStats.lastActive !== user.stats.lastActive) {
