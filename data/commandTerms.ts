...
const TIER_COLORS = [
  { color: 'text-red-300 light:text-red-700 print:text-red-700', bg: 'bg-red-900/30 light:bg-red-100 print:bg-red-100' },       // Tier 0 (fallback)
  { color: 'text-red-300 light:text-red-700 print:text-red-700', bg: 'bg-red-900/30 light:bg-red-100 print:bg-red-100' },       // Tier 1
  { color: 'text-orange-300 light:text-orange-700 print:text-orange-700', bg: 'bg-orange-900/30 light:bg-orange-100 print:bg-orange-100' }, // Tier 2
  { color: 'text-yellow-300 light:text-yellow-700 print:text-yellow-700', bg: 'bg-yellow-900/30 light:bg-yellow-100 print:bg-yellow-100' }, // Tier 3
  { color: 'text-green-300 light:text-green-700 print:text-green-700', bg: 'bg-green-900/30 light:bg-green-100 print:bg-green-100' },   // Tier 4
  { color: 'text-sky-300 light:text-sky-700 print:text-sky-700', bg: 'bg-sky-900/30 light:bg-sky-100 print:bg-sky-100' },       // Tier 5
  { color: 'text-purple-300 light:text-purple-700 print:text-purple-700', bg: 'bg-purple-900/30 light:bg-purple-100 print:bg-purple-100' }, // Tier 6
];

export const TIER_GROUPS = [
  { level: 1, title: 'Retrieving & Recalling', subtitle: 'Remember facts or locate information without changing it.', emoji: '🧠', tier: 1, maxBand: 2 },
  { level: 2, title: 'Comprehending & Describing', subtitle: 'Show understanding by organizing or describing.', emoji: '📝', tier: 2, maxBand: 3 },
  { level: 3, title: 'Applying & Demonstrating', subtitle: 'Use knowledge to solve a problem or build an answer.', emoji: '🔧', tier: 3, maxBand: 4 },
  { level: 4, title: 'Analysing & Connecting', subtitle: 'Break down info, find relationships, and explain why.', emoji: '🔍', tier: 4, maxBand: 5 },
  { level: 5, title: 'Synthesising & Arguing', subtitle: 'Bring ideas together or provide a supported point of view.', emoji: '⚖️', tier: 5, maxBand: 6 },
  { level: 6, title: 'Evaluating & Judging', subtitle: 'Determine value, quality, or validity using criteria.', emoji: '🏆', tier: 6, maxBand: 6 },
];
...
export const commandTermsList: Omit<CommandTermInfo, 'tailwind'>[] = [
  ...
  },
  {
    ...
    genericMarkingGuide: ['1 mark: Basic definition.', '2 marks: Comprehensive definition with essential qualities.'],
  ...
  },
  {
    ...
    genericMarkingGuide: ['1 mark: Basic list of events.', '2-3 marks: Accurate sequence of key events.'],
  ...
  },
  {
    ...
    genericMarkingGuide: ['1-2 marks: Identifies characteristics.', '3+ marks: Provides detailed description of features.'],
  ...
  },
  {
    ...
    genericMarkingGuide: ['1 mark: Identifies the ambiguity.', '2+ marks: Clearly explains to resolve confusion.'],
  ...
  },
  {
    ...
    genericMarkingGuide: ['1 mark: Identifies main points.', '2+ marks: Concisely links main points without unnecessary detail.'],
  ...
  },
  {
    ...
    genericMarkingGuide: ['1 mark: Correct classification.', '2 marks: Justification for classification if required.'],
  ...
  // --- Level 3: Applying & Demonstrating ---
  {
    ...
    genericMarkingGuide: ['1 mark: Correct method/formula.', '1 mark: Correct working.', '1 mark: Correct answer with units.'],
  ...
  },
  {
    ...
    genericMarkingGuide: ['1-2 marks: Identifies relevant principle.', '3+ marks: Correctly applies principle to the specific scenario.'],
    structuralKeywords: ['using', 'applying', 'in this case', 'scenario'],
    exampleQuestion: "Apply the principle of supply and demand to explain the recent rise in coffee prices."
  },
  {
    term: 'DEMONSTRATE',
    ...
    genericMarkingGuide: ['1 mark: States the concept.', '2+ marks: Provides a clear, relevant example showing the concept in action.'],
  ...
  },
  {
    ...
    genericMarkingGuide: ['1 mark: Basic elements present.', '2+ marks: Logical, coherent structure or build.'],
  ...
  // --- Level 4: Analysing & Connecting ---
  {
    ...
    genericMarkingGuide: ['1-2 marks: Similarities.', '1-2 marks: Differences.', '1 mark: Synthesis/Conclusion.'],
  ...
  },
  {
    ...
    genericMarkingGuide: ['1 mark: Identifies the entities.', '2+ marks: Clearly explains the distinguishing factor(s).'],
  ...
  {
    term: 'EXPLAIN',
    definition: 'Relate cause and effect; make the relationships between things evident; provide why and/or how.',
    tier: 4,
    markRange: [3, 6],
    targetBands: '3-6',
    bandDiscrimination: 'Clarity of cause-effect relationship.',
    genericMarkingGuide: ['1 mark: Identifies cause.', '1 mark: Identifies effect.', '1-2 marks: Explains the link/relationship.'],
  ...
  },
  {
    ...
    genericMarkingGuide: ['1 mark: Basic reading of data.', '2+ marks: Infers meaning or trends from the data/text.'],
  ...
  },
  {
    ...
    genericMarkingGuide: ['1 mark: Uses evidence.', '2 marks: Draws logical conclusion based on evidence.'],
  ...
  },
  {
    ...
    genericMarkingGuide: ['1 mark: Uses known data.', '2 marks: Logically extends data to new territory.'],
    structuralKeywords: ['extend', 'project', 'future', 'predict'],
    exampleQuestion: "Extrapolate the future growth of the bacteria colony based on the current data."
  },
  {
    term: 'PREDICT',
    ...
    genericMarkingGuide: ['1 mark: States prediction.', '2 marks: Justifies prediction with available info.'],
  ...
  },
  {
    ...
    genericMarkingGuide: ['2 marks: Identifies components.', '2 marks: Explains relationships.', '1-2 marks: Discusses implications.'],
  ...
  },
  {
    ...
    genericMarkingGuide: ['1-2 marks: Identifies key issues.', '2+ marks: Probes details and context.'],
  ...
  },
  {
    ...
    genericMarkingGuide: ['1 mark: Identifies event/phenomenon.', '2+ marks: Provides detailed reasons for its occurrence.'],
  ...
  // --- Level 5: Synthesising & Arguing ---
  {
    ...
    genericMarkingGuide: ['2 marks: Points for.', '2 marks: Points against.', '1 mark: Conclusion/Synthesis.'],
  ...
  {
    term: 'PROPOSE',
    definition: 'Put forward (for example a point of view, idea, argument, suggestion) for consideration or action.',
    tier: 5,
    markRange: [4, 7],
    targetBands: '4-6',
    bandDiscrimination: 'Feasibility and justification of proposal.',
    genericMarkingGuide: ['1 mark: Clear proposal.', '2+ marks: Justification or supporting argument.'],
  ...
  },
  {
    ...
    genericMarkingGuide: ['2 marks: Planning/Method.', '2 marks: Inquiry/Analysis.', '1 mark: Conclusion.'],
  ...
  },
  {
    ...
    genericMarkingGuide: ['2 marks: Identifies separate elements.', '2+ marks: Combines them into a new, coherent conclusion or whole.'],
    structuralKeywords: ['combine', 'integrate', 'overall', 'holistic'],
    exampleQuestion: "Synthesise the information from the three sources to form a conclusion about the health of the river system."
  },
  ...
  },
  {
    ...
    genericMarkingGuide: ['1 mark: Judgement.', '2 marks: Criteria used.', '2+ marks: Evidence weighing.'],
  ...
  },
  {
    ...
    genericMarkingGuide: ['1 mark: States value.', '2+ marks: Explains/justifies the value/quality.'],
  ...
  },
  {
    ...
    genericMarkingGuide: ['1 mark: States argument/conclusion.', '3+ marks: robust support with evidence/logic.'],
    structuralKeywords: ['because', 'reason', 'support', 'evidence'],
    exampleQuestion: "Select one energy solution and justify your choice with environmental and economic evidence."
  },
  {
    term: 'RECOMMEND',
  ...
  },
  {
    ...
    definition: 'Use interpretation and reasoning to assess a range of evidence; add a degree of accuracy, logic, questioning, reflection and quality.',
    tier: 6,
    markRange: [8, 20],
    targetBands: '6',
    bandDiscrimination: 'Depth of questioning and reflection.',
    genericMarkingGuide: ['2 marks: Analysis of evidence.', '2 marks: Assessment/Judgement.', '2+ marks: Critical reflection/questioning.'],
  ...
  },
  {
    ...
    targetBands: '6',
    bandDiscrimination: 'Depth of questioning and reflection.',
    genericMarkingGuide: ['2 marks: Evaluation against criteria.', '2 marks: Assessment/Judgement.', '2+ marks: Critical reflection/questioning.'],
    structuralKeywords: ['critique', 'question', 'validity', 'logic', 'reflection'],
...
export const getCommandTermsForMarks = (marks: number): { terms: CommandTermInfo[], primaryTerm: CommandTermInfo } => {
...
export const getBandForMark = (mark: number, totalMarks: number, tier: number = 4): number => {
  ...
  const thresholds: Record<number, { min: number; band: number }[]> = {
    ...
    5: [ // Synthesise (Tier 5) - Max Band 6
        { min: 0.90, band: 6 },
        { min: 0.75, band: 5 },
        { min: 0.55, band: 4 },
        { min: 0.35, band: 3 },
    ...
    4: [ // Analyse (Tier 4) - Max Band 5
        { min: 0.90, band: 5 }, // 5/5 or 9/10 required for Band 5. 4/5 (0.8) should be Band 4.
        { min: 0.70, band: 4 }, // 4/5 (0.8) -> Band 4. 3/4 (0.75) -> Band 4.
        { min: 0.40, band: 3 }, // 2/5 (0.4) -> Band 3
        { min: 0.20, band: 2 },
        { min: 0,    band: 1 }
    ],
    3: [ // Apply (Tier 3) - Max Band 4
        { min: 0.85, band: 4 }, // 3/3, 4/4 -> Band 4
        { min: 0.60, band: 3 }, // 2/3, 3/4 -> Band 3
        { min: 0.35, band: 2 }, // 1/3, 2/4 -> Band 2 (low)
        { min: 0,    band: 1 }
    ],
    2: [ // Describe (Tier 2) - Max Band 3
        { min: 0.85, band: 3 }, // 3/3 -> Band 3
        { min: 0.50, band: 2 }, // 2/3 -> Band 2
        { min: 0,    band: 1 }
    ],
    1: [ // Identify (Tier 1) - Max Band 2
        { min: 0.50, band: 2 },
        { min: 0,    band: 1 }
    ]
  };
...
export const getStructureGuide = (mark: number): string => {
    ...
    if (mark === 2) return "Recall two distinct points OR one point + a brief example. (Approx 15-40 words)";
    if (mark === 3) return "Three clear points OR two points + one relevant example OR a simple cause-effect link. (Approx 40-80 words)";
    if (mark === 4) return "Clear explanation with at least two linked points and one specific example/quote. Logical connections shown. (Approx 80-120 words)";
    if (mark === 5) return "Detailed explanation OR beginning of analysis: breaks concept into parts, shows relationships, uses specific evidence. (Approx 110-160 words)";
    if (mark === 6) return "Sophisticated breakdown of components, clear patterns/relationships identified, multiple pieces of evidence integrated. (Approx 140-220 words)";
    if (mark === 7) return "Analysis + explicit judgement or assessment of significance/effectiveness/limitations. Weighs evidence. (Approx 180-280 words)";
    if (mark === 8) return "Sustained judgement supported by detailed, integrated evidence. Consider alternatives or implications. (Approx 220-350 words)";
    if (mark === 9) return "Perceptive, nuanced judgement. Addresses counter-arguments or limitations. Original insight. (Approx 280-400 words)";
