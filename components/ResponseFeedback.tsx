...
const ResponseFeedback: React.FC<ResponseFeedbackProps> = ({ onFeedbackSubmit, existingFeedback }) => {
  const [rating, setRating] = useState<'positive' | 'negative' | null>(existingFeedback?.rating || null);
        ...
        {showCommentBox && (
          <div className="space-y-3 animate-fade-in-up-sm">
            <textarea
              ...
              placeholder={rating === 'positive' ? "What did the AI do well?" : "How could this response be improved?"}
