...
const CognitiveSpectrum: React.FC<CognitiveSpectrumProps> = ({
  tier,
  term,
  className = '',
  showLabel = true,
  ...
  return (
    <div
      className={`flex items-center gap-3 px-3 py-1.5 rounded-lg bg-[rgb(var(--color-bg-surface-inset))]/30 border border-[rgb(var(--color-border-secondary))]/50 ${className}`}
    >
      {showLabel && term && (
