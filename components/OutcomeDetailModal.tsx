      ...
      >
        ...
        <div className="p-6 space-y-6 overflow-y-auto flex-1 bg-[rgb(var(--color-bg-surface))] light:bg-white">
            ...
            `}>
                ...
                <h3 className="text-xs font-bold text-[rgb(var(--color-text-muted))] light:text-slate-500 uppercase tracking-wider mb-2">Syllabus Description</h3>
            ...
            <div className="space-y-3">
                ...
                {isLoading ? (
                    <div className="flex flex-col items-center justify-center h-32 gap-3">
                        ...
                        <p className="text-xs text-purple-300 light:text-purple-600 animate-pulse">Analysing syllabus context...</p>
                    </div>
                ) : error ? (
                    <div className="bg-red-900/20 light:bg-red-50 p-4 rounded-lg border border-red-500/30 light:border-red-200 flex items-start gap-3">
                        ...
                        <div>
                            <p className="text-sm text-red-300 light:text-red-800 font-medium">Analysis Failed</p>
                            <p className="text-xs text-red-400/80 light:text-red-600/80 mt-1">{error}</p>
                            <button onClick={fetchExplanation} className="mt-2 text-xs font-bold text-red-300 light:text-red-600 hover:text-white light:hover:text-red-800 underline">Try Again</button>
                        </div>
                    </div>
                ) : (
