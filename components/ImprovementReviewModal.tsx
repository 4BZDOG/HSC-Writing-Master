        ...
        <div className={`px-6 py-5 border-b border-[rgb(var(--color-border-secondary))] light:border-slate-200 bg-gradient-to-r ${bandConfig.gradient} relative overflow-hidden flex-shrink-0`}>
             ...
             <div className="flex items-center justify-between relative z-10">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h2 className="text-xl font-bold text-white tracking-tight">AI Improvement Suggestion</h2>
                        <div className="flex items-center gap-2 text-white/90 font-medium text-sm">
                             <span className="bg-white/20 px-2 py-0.5 rounded text-xs font-bold uppercase tracking-wider">Review Changes</span>
                             <span>•</span>
