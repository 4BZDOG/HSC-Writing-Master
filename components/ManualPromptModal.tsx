    ...
    return createPortal(
      ...
      >
        ...
        >
          {/* Header */}
          <div
            className={`px-10 py-8 border-b border-[rgb(var(--color-border-secondary))] light:border-slate-200 bg-gradient-to-r from-indigo-500/10 to-purple-500/10 light:from-indigo-50 light:to-purple-50 relative flex-shrink-0`}
          >
            <MeshOverlay />
            <div className="flex justify-between items-start relative z-10">
              <div className="flex items-center gap-5">
                ...
                <div>
                  <h2 className="text-2xl font-black text-white light:text-slate-900 tracking-tight leading-none uppercase italic">
                    Manual Entry
                  </h2>
