  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center pointer-events-none">
        ...
        `}>
            {isDragActive ? <FileJson className="w-8 h-8 animate-bounce" /> : <UploadCloud className="w-8 h-8" />}
        </div>
        ...
        <p className="text-sm text-[rgb(var(--color-text-muted))]">
          Accepts <span className="font-mono text-[rgb(var(--color-accent))]">.json</span> course files
        </p>
      </div>
    </div>
  );
