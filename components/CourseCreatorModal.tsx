          ...
          <div className="p-6 space-y-5 flex-grow overflow-y-auto">
            ...
            <div className="rounded-xl border border-[rgb(var(--color-border-secondary))] light:border-slate-200 overflow-hidden">
              ...
              >
                ...
                {outcomesExpanded ? (
                  <ChevronUp className="w-4 h-4 text-[rgb(var(--color-text-muted))] light:text-slate-400" />
                ) : (
                  <ChevronDown className="w-4 h-4 text-[rgb(var(--color-text-muted))] light:text-slate-400" />
                )}
              </button>
