  ...
  return createPortal(
    <div className="fixed inset-0 z-[2000] bg-[rgb(var(--color-bg-base))]/60 light:bg-slate-50/60 backdrop-blur-sm flex items-center justify-center animate-fade-in cursor-wait">
      <div className="relative">
        ...
        <div className={`absolute inset-0 bg-gradient-to-r ${isErrorState ? 'from-red-500 to-orange-500' : 'from-[rgb(var(--color-primary))] to-[rgb(var(--color-accent))]'} rounded-2xl blur-xl opacity-20 animate-pulse-glow`}></div>
