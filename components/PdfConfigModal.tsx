      ...
      <div className="bg-[rgb(var(--color-bg-surface))] rounded-2xl border border-[rgb(var(--color-border-secondary))] w-full max-w-md shadow-2xl overflow-hidden animate-fade-in-up">
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="text-xs font-bold uppercase tracking-wider text-[rgb(var(--color-text-muted))] block mb-1.5">
                Scale (Quality)
              </label>
              <input
                type="number"
          ...
          <div>
            <div className="flex justify-between items-center mb-2">
              ...
              <button
                onClick={handleReset}
                className="text-[10px] text-[rgb(var(--color-accent))] hover:underline flex items-center gap-1"
              >
            ...
            <div className="grid grid-cols-4 gap-3">
              {['Top', 'Right', 'Bottom', 'Left'].map((side) => {
                ...
                return (
                  <div key={side}>
                    <label className="text-[10px] text-center block mb-1 text-[rgb(var(--color-text-secondary))]">
                      {side}
                    </label>
                    <input
                      type="number"
